...
highFrequency
{
	...
	for(p = 0; <= cNumberNonGaiaPlayers){
		...
		modifyProtounitAbsolute("Tower", p, 17, 1000+(Difficulty*250));
	...
	trModifyProtounit("Hero Greek Jason", cNumberNonGaiaPlayers, 0, 400);
	trModifyProtounit("Hero Greek Jason", cNumberNonGaiaPlayers, 27, 25);
	trModifyProtounit("Hero Greek Jason", cNumberNonGaiaPlayers, 29, 25);
	trModifyProtounit("Hero Greek Odysseus", cNumberNonGaiaPlayers, 0, 550);
	trModifyProtounit("Hero Greek Odysseus", cNumberNonGaiaPlayers, 31, 25);
	trModifyProtounit("Hero Greek Odysseus", cNumberNonGaiaPlayers, 32, 35);
	trModifyProtounit("Hero Greek Bellerophon", cNumberNonGaiaPlayers, 0, 800);
	trModifyProtounit("Hero Greek Bellerophon", cNumberNonGaiaPlayers, 27, 50);
	trModifyProtounit("Hero Greek Bellerophon", cNumberNonGaiaPlayers, 29, 50);
	trModifyProtounit("Hero Greek Hippolyta", cNumberNonGaiaPlayers, 0, 1000);
	trModifyProtounit("Hero Greek Hippolyta", cNumberNonGaiaPlayers, 31, 65);
	trModifyProtounit("Hero Greek Hippolyta", cNumberNonGaiaPlayers, 32, 65);
	trModifyProtounit("Hero Greek Polyphemus", cNumberNonGaiaPlayers, 0, 1500);
	trModifyProtounit("Hero Greek Polyphemus", cNumberNonGaiaPlayers, 27, 140);
	trModifyProtounit("Hero Greek Polyphemus", cNumberNonGaiaPlayers, 29, 140);
